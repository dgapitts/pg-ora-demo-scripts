CREATE OR REPLACE FUNCTION primefactors_stable (integer) RETURNS table (f1 int)
AS $$
...
select primefactors_stable(7);
select primefactors_stable(9);
select primefactors_stable(66);
